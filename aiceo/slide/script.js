/* ============================================
   THE AI CEO 2025 — Presentation Controller
   Navigation: Keyboard, Touch, Wheel
   Features: Progress, Counter, Goto Modal
   ============================================ */
...
const animateSlideIn = (slide) => {
    ...
    const animatables = slide.querySelectorAll('.card, .stat-card, .sol-item, .comp-step, .testi-card, .guarantee-card, .obj-card, .timeline-item, .leak-item');
