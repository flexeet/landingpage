// ===================================================================
// SCRIPT FOR FLOATING GLASS NAVIGATION (iOS-STYLE)
// ===================================================================

// Melindungi scope global dengan Immediately Invoked Function Expression (IIFE)
(function() {
    ...
    /**
     * Menginisialisasi fungsionalitas smooth scroll untuk semua link anchor.
     */
    function setupSmoothScrolling() {
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                const href = this.getAttribute('href');
                // Pastikan itu adalah anchor yang valid dan bukan hanya "#"
